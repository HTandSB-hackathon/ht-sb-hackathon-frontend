...
const MOCK_CHARACTERS: Character[] = [
  {
    ...
    coverImage: "https://images.unsplash.com/photo-1625948515291-69613efd103f?w=800&h=400&fit=crop",
    introduction: "須賀川でキュウリとお米を作っています。毎日畑で汗を流していますが、それが私の生きがいです。新鮮な野菜の美味しさを、もっと多くの人に知ってもらいたいです。",
  ...
  },
  {
    ...
    coverImage: "https://images.unsplash.com/photo-1519904981063-b0cf448d479e?w=800&h=400&fit=crop",
    introduction: "三春町で40年間、小学校の教師をしていました。今は地域の子どもたちに昔の遊びを教えています。三春の滝桜は日本一美しいと思っています。",
  ...
  },
  {
    ...
    introduction: "中島村で小さなカフェを営んでいます。地元の食材を使った料理と、温かいおもてなしが自慢です。村の魅力を一人でも多くの人に伝えたいです。",
  ...
  },
  {
    ...
    introduction: "須賀川で桃とりんごの果樹園を営んでいます。祖父の代から続く果樹園を守りながら、新しい品種にも挑戦しています。",
  ...
  },
  {
    ...
    city: "三春町",
    prefecture: "福島県",
    profileImage: "https://images.unsplash.com/photo-1441123100240-f9f3f77ed41b?w=400&h=400&fit=crop",
    coverImage: "https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=800&h=400&fit=crop",
    introduction: "三春町で民宿を営んで30年。全国から来るお客様に、福島の温かさを感じてもらえるよう心を込めておもてなししています。",
...
const MOCK_RELATIONSHIPS: Record<string, CharacterRelationship> = {
  "1": {
    ...
    lastConversationAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
  ...
  "2": {
    ...
    lastConversationAt: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString(),
...
export class CharacterQuery {
   ...
   * キャラクター詳細を取得
   */
  static async getCharacterDetail(characterId: string): Promise<CharacterDetail> {
    // モック遅延
    ...
    const detail: CharacterDetail = {
      ...
      stories: [
        ...
        },
        {
          ...
          unlockedAt: character.id === "1" || character.id === "3" ? "2024-01-15T00:00:00Z" : undefined
        },
        {
          id: "story3",
          title: "あなたに伝えたいこと",
      ...
      localSpecialties: [
        {
          id: "sp1",
          name: character.city === "須賀川市" ? "きゅうり" : character.city === "三春町" ? "三春そうめん" : "トマト",
          description: "地元の特産品です",
          imageUrl: "https://images.unsplash.com/photo-1556909114-44e3e70034e2?w=200&h=200&fit=crop",
          season: "夏",
