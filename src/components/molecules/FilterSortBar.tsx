...
// 					<h2 className="text-lg font-bold text-gray-800">出会った人たち</h2>
...
// 											key={level}
// 											onClick={() =>
// 												onFilterChange({ ...filter, trustLevel: level })
// 											}
// 											className={`
...
// 											type="button"
// 											onClick={() =>
// 												onFilterChange({ ...filter, gender: "male" })
// 											}
// 											className={`
//                         px-3 py-1 text-sm rounded-full transition-colors
...
// 											type="button"
// 											onClick={() =>
// 												onFilterChange({ ...filter, gender: "female" })
// 											}
// 											className={`
//                         px-3 py-1 text-sm rounded-full transition-colors
...
// 											type="button"
// 											onClick={() =>
// 												onFilterChange({ ...filter, isLocked: false })
// 											}
// 											className={`
//                         px-3 py-1 text-sm rounded-full transition-colors
...
// 											type="button"
// 											onClick={() =>
// 												onFilterChange({ ...filter, isLocked: true })
// 											}
// 											className={`
//                         px-3 py-1 text-sm rounded-full transition-colors
