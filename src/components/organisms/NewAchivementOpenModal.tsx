import type { Achivement } from "@/lib/domain/AchivementQuery";
import {
	Avatar,
	Box,
	Button,
...
export const NewAchivementOpenModal: React.FC<NewAchivementOpenModalProps> = ({
	isOpen,
	onClose,
	achivement,
}) => {
