...
const LandingPage: React.FC = () => {
  ...
  const heroButtonDirection = useBreakpointValue({ base: "column", md: "row" }) as any;
      ...
      <Container maxW={containerMaxW} position="relative" zIndex="1">
          ...
          <VStack spacing={8} textAlign="center" py={20}>
            ...
            <MotionBox variants={fadeInUp}>
              <HStack spacing={4} wrap="wrap" justify="center">
                {[
                  { icon: MdVerifiedUser, text: '本人確認済み', color: 'green' },
              ...
              {[
                {
                  ...
                  description: "福島で生きる人々の想いや体験をAIが忠実に再現。会話を重ねることで、その人の人生観や福島への愛が伝わってきます。",
                  features: ["個性豊かなAIキャラクター", "親密度システムで関係性が深化", "福島弁での自然な会話"],
                  color: "blue",
                ...
                },
                {
                  ...
                  description: "会津の武士道精神、相馬野馬追いの伝統、震災からの復興など、福島の歴史をキャラクターの体験談として学べます。",
                  features: ["歴史的人物との対話", "文化的背景の深い理解", "時代を超えた知恵の継承"],
                  color: "purple",
                ...
                },
                {
                  ...
                  description: "桜前線の北上、夏祭りの熱気、紅葉の絶景、雪国の厳しさと温かさ。福島の四季をキャラクターと一緒に体感できます。",
                ...
                },
                {
                  ...
                  description: "観光ガイドには載らない隠れスポット、代々受け継がれる家庭料理のレシピ、地元民の暮らしの知恵を教わります。",
              ...
              {[
                {
                  ...
                  icon: FaUsers,
                  color: "blue",
                  details: ["多様な背景のキャラクター", "地域・時代・職業で選択", "それぞれの人生ストーリー"]
                },
                {
                  step: "2", 
                  title: "会話で親密度を深める",
              ...
              {[
                {
                  icon: FaHeart,
                  title: "真剣な出会い",
                  description: "遊びではなく、真剣に恋愛や結婚を考える福島の方々との素敵な出会いをサポート",
                  color: "red",
                ...
                >
                  <CardBody p={8}>
                    <VStack spacing={6}>
                      ...
                      <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8} w="full">
                        {[
                          { metric: "平均対話継続時間", value: "3.2時間", change: "+127%" },
                          { metric: "福島知識習得率", value: "89.4%", change: "+156%" },
                          { metric: "リピート利用率", value: "94.7%", change: "+98%" },
                        ].map((metric, index) => (
                ...
                {[
                  {
                    ...
                    avatar: "🌸",
                    character: "会津の武家の娘",
                    content: "故郷を離れて10年、福島のことを忘れかけていました。でも会津の武家の娘のAIと話すうちに、祖母から聞いた昔話や、会津の誇り高い精神を思い出しました。涙が止まりませんでした。",
                    rating: 5,
                  ...
                  },
                  {
                    ...
                    content: "桃農家のAIおじいちゃんから、桃作りの苦労や喜び、福島の桃への誇りを聞きました。同じ福島に住んでいても知らないことばかり。福島がもっと好きになりました。",
                    rating: 5,
                  ...
                  },
                  {
                    ...
                    avatar: "🌊",
                    character: "漁師のおかみさん",
                    content: "いわきの漁師のおかみさんとの会話で、震災の時の話や海への想いを聞かせてもらいました。福島の強さと優しさを改めて感じ、地元への愛がより深くなりました。",
                    rating: 5,
                  ...
                  },
                  {
                    ...
                    avatar: "⚔️",
                    character: "白虎隊の隊士",
                    content: "白虎隊の隊士との対話は圧巻でした。教科書では学べない、当時の想いや会津魂を直接聞けるなんて。福島の歴史への理解が格段に深まりました。",
                    rating: 5,
                          ...
                          <VStack align="start" spacing={2} flex="1">
                            ...
                            <HStack spacing={1}>
                              {[...Array(testimonial.rating)].map((_, i) => (
                                <Icon key={i} as={FaStar} color="yellow.300" boxSize={4} />
                              ))}
                            </HStack>
                          </VStack>
                        </HStack>
                ...
                <Card bg="whiteAlpha.100" backdropFilter="blur(10px)" borderRadius="2xl">
                  <CardBody p={6}>
                    <SimpleGrid columns={{ base: 2, md: 4 }} spacing={6}>
                      {[
                        { label: "平均対話時間", value: "2.5時間", icon: FaComment },
        ...
        <Box py={12} textAlign="center" borderTop="1px" borderColor="gray.200">
          <VStack spacing={4}>
            ...
            <HStack spacing={6}>
              <Text fontSize="sm" color="gray.400">© 2024 福島のこころ</Text>
              <Text fontSize="sm" color="gray.400">プライバシーポリシー</Text>
              <Text fontSize="sm" color="gray.400">利用規約</Text>
            </HStack>
          </VStack>
        </Box>
      </Container>
