...
const RegisterPage: React.FC = () => {
  ...
  const containerMaxW = useBreakpointValue({ base: "full", sm: "md", md: "lg", lg: "xl" });
  ...
  const validateCurrentStep = () => {
    ...
    if (activeStep === 0) {
      ...
      if (formData.username.length < 3) newErrors.username = 'ユーザー名は3文字以上で入力してください';
            ...
            <VStack spacing={4} textAlign="center">
              ...
              <HStack spacing={4} wrap="wrap" justify="center" mt={6}>
                {[
                  ...
                  { icon: MdGroup, text: '温かいコミュニティ', color: 'purple' },
                ].map((feature, index) => (
                  <MotionBox
                    key={index}
                  ...
                  >
                    <Card size="sm" bg="whiteAlpha.200" backdropFilter="blur(10px)" border="1px solid" borderColor="whiteAlpha.300">
                      <CardBody p={3}>
                        <HStack spacing={2}>
                  ...
                  >
                    <VStack spacing={6} align="stretch">
                      <Box textAlign="center">
                        ...
                        <Heading size="lg" mb={2}>はじめまして！</Heading>
                        <Text color="gray.600">
                          あなたの基本情報を教えてください
                        </Text>
                      </Box>
                ...
                {activeStep === 1 && (
                  ...
                  >
                    <VStack spacing={6} align="stretch">
                      <Box textAlign="center">
                        <Text fontSize="2xl" mb={2}>🔐</Text>
                        <Heading size="lg" mb={2}>安全なパスワードを設定</Heading>
                        <Text color="gray.600">
                ...
                {activeStep === 2 && (
                  ...
                  >
                    <VStack spacing={6} align="stretch">
                      <Box textAlign="center">
                        <Text fontSize="2xl" mb={2}>📄</Text>
                        <Heading size="lg" mb={2}>利用規約への同意</Heading>
                        <Text color="gray.600">
                      ...
                      <VStack spacing={4} align="stretch">
                        ...
                        <FormControl isInvalid={!!errors.agreeTerms}>
                          ...
                          >
                            <Text fontSize="sm">
                              <Link color="purple.500" textDecoration="underline" href="#" isExternal>
                                利用規約
                              </Link>
                              および
                              <Link color="purple.500" textDecoration="underline" href="#" isExternal ml={1}>
                                プライバシーポリシー
                              </Link>
                              に同意します（必須）
                            </Text>
